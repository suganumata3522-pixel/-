...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var ARTICLES = [
    ...
    { title: 'ストラット・タイモデルとは？偏心基礎フーチングの検討と無料Excel', url: 'articles/strut-tie.html', keywords: 'ストラットタイモデル ストラット タイ モデル 偏心基礎 フーチング 杭 検討 Excel 無料 ダウンロード 圧縮応力度 許容応力度 RC規準 トラス 柱軸力 杭芯 せん断 基礎' },
