...
bodytext("各種手摺配筋詳細図、片持ちスラブ先端壁・手摺配筋詳細図、パラペット配筋詳細図について拡大図を記載してみました。"
         "図面間の濃度差を統一するという観点から、以降の図面についての方針を決めたいと考えています。", h=40)
options([
    ("A", "配筋が細かく分かりにくい図面には拡大図を併記する"),
    ("B", "拡大図は本当に必要なものに絞るべきで、現状の表現は過剰"),
])
answer("回答（A / B）とその理由", dropdown=["A", "B"])
bodytext("「拡大図が必要」と判断する基準について、ご意見をお聞かせください。"
         "（例：鉄筋本数、定着・継手の有無、納まりの複雑さ など）", h=30)
answer("判断基準についてのご意見", h=46)
spacer()
