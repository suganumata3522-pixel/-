...
body(ws, r + 5, "Lb = (σt / (4·fb)) · db（鉄筋の引張力と付着抵抗の釣合いから導かれる）。"
...
an("問1：L2=A 直線定着長、L2h=B フック付き定着長、La=C 折り曲げ定着の投影定着長、"
   "Lb=D 基本定着長。", h=32)
an("問2：Lb = (σt/(4·fb))·db = (295/(4×2.0))·22 = 36.9×22 = 811 ≒ 810mm（約37db）。慣用の40dとおおむね対応する。釣合い：T=σt·(π·db²/4) ＝ 付着抵抗 fb·(π·db)·Lb。",
   h=44)
